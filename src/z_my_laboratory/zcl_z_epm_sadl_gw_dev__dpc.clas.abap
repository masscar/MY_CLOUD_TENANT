class ZCL_Z_EPM_SADL_GW_DEV__DPC definition
  public
...
protected section.
  ...
  methods SALESORDERITEMS_UPDATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TS_SALESORDERITEM
    raising
  ...
  methods SALESORDERITEMS_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TT_SALESORDERITEM
  ...
  methods SALESORDERHEADER_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TS_SALESORDERHEADER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SALESORDERHEADER_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TT_SALESORDERHEADER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRODUCTS_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TS_PRODUCT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TT_PRODUCT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRODUCTS_CREATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTCATEGORIE_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TS_PRODUCTCATEGORY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTCATEGORIE_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TT_PRODUCTCATEGORY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTCATEGORIE_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTCATEGORIE_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PRODUCTCATEGORIE_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods CUSTOMERS_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TS_CUSTOMER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods CUSTOMERS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z_EPM_SADL_GW_DEV__MPC=>TT_CUSTOMER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_Z_EPM_SADL_GW_DEV__DPC IMPLEMENTATION.
...
*&* This class has been generated on 30.09.2019 14:05:37 in client 900
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EPM_SADL_GW_DEV__DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA products_create_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_product.
 DATA productcategorie_create_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_productcategory.
 DATA customers_create_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_customer.
 DATA salesorderitems_create_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderitem.
 DATA salesorderheader_create_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderheader.
...
*     Call the entity set generated method
    productcategorie_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = productcategorie_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = productcategorie_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'ProductCategories'.
*     Call the entity set generated method
     productcategorie_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA products_get_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_product.
 DATA customers_get_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_customer.
 DATA salesorderitems_get_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderitem.
 DATA salesorderheader_get_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderheader.
 DATA productcategorie_get_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_productcategory.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          productcategorie_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = productcategorie_get_entity
                         es_response_context = es_response_context
          ).

        IF productcategorie_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = productcategorie_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_EPM_SADL_GW_DEV__DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA products_get_entityset TYPE zcl_z_epm_sadl_gw_dev__mpc=>tt_product.
 DATA customers_get_entityset TYPE zcl_z_epm_sadl_gw_dev__mpc=>tt_customer.
 DATA salesorderitems_get_entityset TYPE zcl_z_epm_sadl_gw_dev__mpc=>tt_salesorderitem.
 DATA salesorderheader_get_entityset TYPE zcl_z_epm_sadl_gw_dev__mpc=>tt_salesorderheader.
 DATA productcategorie_get_entityset TYPE zcl_z_epm_sadl_gw_dev__mpc=>tt_productcategory.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'ProductCategories'.
*     Call the entity set generated method
      productcategorie_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = productcategorie_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = productcategorie_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productcategorie_update_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_productcategory.
 DATA salesorderheader_update_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderheader.
 DATA salesorderitems_update_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_salesorderitem.
 DATA customers_update_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_customer.
 DATA products_update_entity TYPE zcl_z_epm_sadl_gw_dev__mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'ProductCategories'.
*     Call the entity set generated method
          productcategorie_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = productcategorie_update_entity
          ).
       IF productcategorie_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = productcategorie_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_snwd_pd_catgos_1 TYPE snwd_pd_catgos ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="V2" >| &
               | <sadl:dataSource type="DDIC" name="ProductCategories" binding="SNWD_PD_CATGOS" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="ProductCategories" dataSource="ProductCategories" maxEditMode="RO" >| &
               | <sadl:query name="EntitySetDefault">| &
               | </sadl:query>| &
               | <sadl:attribute name="CATEGORY" binding="CATEGORY" isKey="TRUE" />| &
               | <sadl:attribute name="CATEGORYNAME" binding="CATEGORY" isKey="FALSE" />| &
               | <sadl:attribute name="MAINCATEGORY" binding="MAIN_CATEGORY" isKey="FALSE" />| &
               | <sadl:attribute name="MAINCATEGORYNAME" binding="MAIN_CATEGORY" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20190930120543
               iv_uuid              = 'Z_EPM_SADL_GW_DEV_SCEN'
               io_query_control     = me
...
RETURN.
  ...
  method PRODUCTCATEGORIE_CREATE_ENTITY.
  ...
  method PRODUCTCATEGORIE_DELETE_ENTITY.
    if_sadl_gw_dpc_util~get_dpc( )->delete_entity( io_tech_request_context ).
  endmethod.


  method PRODUCTCATEGORIE_GET_ENTITY.
  ...
  method PRODUCTCATEGORIE_UPDATE_ENTITY.
