*&---------------------------------------------------------------------*
*& Report  Z_ABAP_CODE_SHOW_BACKUP                                     *
*&                                                                     *
*&---------------------------------------------------------------------*
...
*&
*&---------------------------------------------------------------------*
REPORT z_abap_code_show_backup         MESSAGE-ID z_abap_4_hana
...
*&---------------------------------------------------------------------*
*&      Form  SHOW_BACKUPE_CODE
*&---------------------------------------------------------------------*
*       text
*----------------------------------------------------------------------*
FORM show_backup_code .
...
DATA:
  ...
  WRITE:/001 gs_backup_object-object ,
             gs_backup_object-obj_name ,
             gs_backup_object-main_program ,
             gs_backup_object-include_program .
  SKIP 2 .

  LOOP AT gt_abap_lines ASSIGNING <abap_line> .
    WRITE:/001 <abap_line> .
  ENDLOOP .
