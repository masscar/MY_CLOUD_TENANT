CLASS z_tutorial_simple_daemon DEFINITION
  PUBLIC
...
CLASS Z_TUTORIAL_SIMPLE_DAEMON IMPLEMENTATION.


  METHOD if_abap_daemon_extension~on_accept .
    TRY.
      DATA lv_program_name TYPE program.
      lv_program_name = cl_oo_classname_service=>get_classpool_name( 'Z_TUTORIAL_SIMPLE_DAEMON' ) .
...
ENDMETHOD .
  ...
  METHOD send .
    ...
    DATA(lt_ad_info) = cl_abap_daemon_client_manager=>get_daemon_info( i_class_name = 'Z_TUTORIAL_SIMPLE_DAEMON' ) .
